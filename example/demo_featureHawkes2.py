"""
An example of a generalized Hawkes process model with features, but features are not available from dataset.
In that case, we learn the features as an embedding layer
"""
...
alpha_dict = {'model_name': 'LinearEndogenousImpact',
              'parameter_set': {'activation': 'identity',
...
hawkes_model.plot_exogenous(all_events,
                            output_name='{}/{}/exogenous_featureHawkes2.png'.format(util.POPPY_PATH, util.OUTPUT_DIR))

# plot endogenous Granger causality
hawkes_model.plot_causality(all_events,
                            output_name='{}/{}/causality_featureHawkes2.png'.format(util.POPPY_PATH, util.OUTPUT_DIR))
